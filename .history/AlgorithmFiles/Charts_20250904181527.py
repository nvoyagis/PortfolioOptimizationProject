...
def dual_single_bar_graph_wins(data: dict, y_label: str, title: str, wins: dict, sims: int):
    ...
    plt.xticks(x, portfolios, rotation=90, fontsize=13, fontname="Segoe UI")
    plt.xlabel('Portfolio', fontsize=16, fontname="Segoe UI")
    plt.ylabel(y_label, fontsize=16, fontname="Segoe UI")
    plt.title(title, fontsize=16, fontname="Segoe UI")
