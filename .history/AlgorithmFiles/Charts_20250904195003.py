...
def dual_single_bar_graph_wins(data: dict, y_label: str, title: str, wins: dict, sims: int):
    ...
    plt.xticks(x, portfolios, rotation=90, fontsize=13, fontname="Optima")
    plt.xlabel('Portfolio', fontsize=16, fontname='Optima')
    plt.ylabel(y_label, fontsize=16, fontname='Optima')
    plt.title(title, fontsize=16, fontname="Optima")
