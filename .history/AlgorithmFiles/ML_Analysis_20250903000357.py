...
db_svm_optimizer([df06], [df07]) # Good
...
db_svm_optimizer([df13], [df14]) # Bad
db_svm_optimizer([df14], [df15]) # Bad
db_svm_optimizer([df15], [df16]) # Bad
db_svm_optimizer([df16], [df17]) # Good
db_svm_optimizer([df17], [df18]) # Bad
