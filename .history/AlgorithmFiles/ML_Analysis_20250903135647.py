...
# db_svm_optimizer([df01, df02], [df03]) # Bad
# db_svm_optimizer([df02, df03], [df04]) # Bad
# db_svm_optimizer([df03, df04], [df05]) # Bad
# db_svm_optimizer([df04, df05], [df06]) # Good
# db_svm_optimizer([df05, df06], [df07])
# db_svm_optimizer([df06, df07], [df08]) # Good
# db_svm_optimizer([df07, df08], [df09]) # Good
# db_svm_optimizer([df08, df09], [df10]) # Good
# db_svm_optimizer([df09, df10], [df11]) # Neutral
# db_svm_optimizer([df10, df11], [df12]) # Bad
# db_svm_optimizer([df11, df12], [df13]) # Bad
# db_svm_optimizer([df12, df13], [df14]) # Bad
# db_svm_optimizer([df13, df14], [df15]) # Bad
# db_svm_optimizer([df14, df15], [df16]) # Bad
# db_svm_optimizer([df15, df16], [df17]) # Good
# db_svm_optimizer([df16, df17], [df18]) # Bad
# db_svm_optimizer([df17, df18], [df19]) # Bad
