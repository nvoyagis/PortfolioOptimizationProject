...
db_svm_optimizer([df06, df07], [df08]) # 
db_svm_optimizer([df07, df08], [df09]) # 
db_svm_optimizer([df08, df09], [df10]) # 
db_svm_optimizer([df09, df10], [df11]) # 
db_svm_optimizer([df10, df11], [df12]) # 
