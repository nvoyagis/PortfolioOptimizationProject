...
def svm_classifier(df: pd.DataFrame, test_size=0.25, plot_cm=True):
    ...
    def _explain(best_model, Xtr, Xte, label):
    ...
    shap_out1 = _explain(model1, x1_train, x1_test, "SPX outperformance (y1)")
    shap_out2 = _explain(model2, x2_train, x2_test, "Avg return > 0 (y2)")
