...
def example_dual_p2():
    ...
    # Manually position the nodes to match the diagram
    pos = {
        12: (0.3, 1.5),
        13: (0.0, 0.8),
        9: (0.4, 0.6),
    ...
    # Add second parallel (curved) edge between 13 and 12
    ax = plt.gca()
    ax.annotate("",
        xy=pos[12], xycoords='data',
    ...
    # First curved edge (offset opposite direction)
    ax.annotate("",
        xy=pos[12], xycoords='data',
        xytext=pos[13], textcoords='data',
        arrowprops=dict(arrowstyle="-", color="black",
