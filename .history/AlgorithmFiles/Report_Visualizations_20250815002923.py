...
def example_dual_p2():
    ...
    nx.draw_networkx_edges(G, pos, width=2, edge_color="black", zorder=1)

    # Draw curved edges separately
    ax = plt.gca()
    ax.annotate("", xy=pos[12], xycoords='data',
    ...
    nx.draw_networkx_labels(G, pos, font_size=12, zorder=3)
