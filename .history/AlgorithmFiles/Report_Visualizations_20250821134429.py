...
def example_dual_p2():
    ...
    D = {
        ...
        "B": (0.38, 0.45),  # face (1-3-4)
        "C": (0.62, 0.45),  # face (2-3-4)
        "D": (0.38, 0.65),  # face (1-4-5)
        "E": (0.62, 0.65),  # face (2-4-5)
    ...
    for v,(x,y) in P.items():
        ax.scatter([x],[y], s=800, edgecolors="black", color="blue", zorder=2)
    ...
    c1 = (x5 + 0.20, y5 + 0.35)   # just above/right of 5
    c2 = (x5 - 0.20, y5 + 0.25)   # above/left toward F
    ...
    for f,(x,y) in D.items():
        ax.scatter([x],[y], s=600, edgecolors="black", color="red", zorder=4)
        ax.text(x+0.02, y+0.02, f, fontsize=10, weight="bold",
