...
df1 = Database.table_into_df('stocks:60 1:2023-01-03 2:2023-01-31 3:2023-02-01 4:2023-02-28')
...
# Calculate % of wins per portfolio
# Colorcode based on frequent edges
# Plot with make_bar_graph

Charts.make_bar_graph(portfolio_dict, 'Portfolio', 'Probability of Outperforming the S&P 500', 'Probability of Outperforming the S&P 500 per Portfolio', sims=100, highlight_dict=highlight_dict)
