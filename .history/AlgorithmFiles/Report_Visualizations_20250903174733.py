...
def example_rbf_svm(df: pd.DataFrame,
    ...
    ax.set_xlabel('Historical Percent Change', fontsize=16)
    ax.set_ylabel('Second Order Centrality', fontsize=16)
    ax.set_title('SVC Using an Optimized Gaussian Kernel', fontsize=16)
    ax.legend(loc="best")
