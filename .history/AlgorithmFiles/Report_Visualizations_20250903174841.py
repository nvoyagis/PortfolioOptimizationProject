...
def example_rbf_svm(df: pd.DataFrame,
    ...
    ax.set_xlabel('Historical Percent Change', fontsize=20)
    ax.set_ylabel('Second Order Centrality', fontsize=20)
    ax.set_title('SVC Using an Optimized Gaussian Kernel', fontsize=20)
