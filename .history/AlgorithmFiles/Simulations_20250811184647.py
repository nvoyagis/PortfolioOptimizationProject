    ...
    with open(os.path.join('Simulations', f'{sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        for i in range(len(node_transparencies)):
            if node_transparencies[i] == 0.5:
                ...
                if node_linewidths[i] == 2.5:
                    success_count += 1
        print('Average Returns (freq): ' + str(success_count/total_count))
        ...
        for i in range(len(node_transparencies)):
            if node_transparencies[i] == 0.5:
                ...
                if node_colors[i] == 'crimson':
                    success_count += 1
        print('Likely to Beat SPX (freq): ' + str(success_count/total_count))
        ...
        for i in range(len(node_transparencies)):
            if node_transparencies[i] == 1:
                ...
                if node_linewidths[i] == 2.5:
                    success_count += 1
        print('Average Returns (non-freq): ' + str(success_count/total_count))
        ...
        for i in range(len(node_transparencies)):
            if node_transparencies[i] == 1:
                ...
                if node_colors[i] == 'crimson':
                    success_count += 1
        print('Likely to Beat SPX (non-freq): ' + str(success_count/total_count))
        ...
        for i in range(len(node_transparencies)):
            if node_linewidths[i] == 2.5:
                success_count += 1
        print('Avg Returns (all): ' + str(success_count/total_count))
        ...
        for i in range(len(node_transparencies)):
            if node_colors[i] == 'crimson':
                success_count += 1
        print('Likely to Beat SPX (all): ' + str(success_count/total_count))
...
analyze_portfolio_file("Simulations/10_3ComboSims_2024-06-28_and_2024-07-01_to_2024-07-31.txt")
analyze_portfolio_file("Simulations/10_3ComboSims_2024-04-30_and_2024-05-01_to_2024-05-31.txt")
...
# simulate(100, 1, stocks, '2023-11-01', '2023-11-30', '2023-12-01', '2023-12-29', frequently_appearing_check=True)
# simulate(100, 1, stocks, '2023-12-01', '2023-12-29', '2024-01-02', '2024-01-31', frequently_appearing_check=True)


# simulate(1, 1, stocks, '2024-01-02', '2024-01-31', '2024-02-01', '2024-02-29', frequently_appearing_check=True)
# simulate(100, 1, stocks, '2024-02-01', '2024-02-29', '2024-03-01', '2024-03-28', frequently_appearing_check=True)
# simulate(1, 1, stocks4, '2024-03-01', '2024-03-28', '2024-04-01', '2024-04-30', frequently_appearing_check=True)
