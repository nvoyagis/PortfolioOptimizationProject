...
def simulate(sims: int, seed: int, stocks: list[str], begin_data_date: str, buy_date: str, sell1: str, sell2: str, analyze_node_features = False, frequently_appearing_check = False):
    ...
    with open(os.path.join('Simulations', f'{sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        if frequently_appearing_check:
            ...
            half_data_collection_length = data_collection_length.days // 2 # 1.5 already used
            days_rounded_for_weeks = round(half_data_collection_length / 7) * 7
...
# simulate_all_3combos(10, 1, stocks, '2023-12-29', '2024-01-02', '2023-01-31')
...
# analyze_portfolio_file("Simulations/10_3ComboSims_2024-07-31_and_2024-08-01_to_2024-08-30.txt")
# analyze_portfolio_file("Simulations/10_3ComboSims_2024-08-30_and_2024-09-03_to_2024-09-30.txt")
...
# simulate(100, 1, stocks, '2023-01-03', '2023-01-31', '2023-02-01', '2023-02-28', frequently_appearing_check=True) NOTE: Done
# simulate(100, 1, stocks, '2023-02-01', '2023-02-28', '2023-03-01', '2023-03-31', frequently_appearing_check=True) NOTE: Done
# simulate(100, 1, stocks, '2023-03-01', '2023-03-31', '2023-04-03', '2023-04-28', frequently_appearing_check=True) NOTE: Done
# simulate(100, 1, stocks, '2023-04-03', '2023-04-28', '2023-05-01', '2023-05-31', frequently_appearing_check=True) NOTE: Done
# simulate(100, 1, stocks, '2023-05-01', '2023-05-31', '2023-06-01', '2023-06-30', frequently_appearing_check=True) NOTE: Done
# simulate(100, 1, stocks, '2023-06-01', '2023-06-30', '2023-07-03', '2023-07-31', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2023-07-03', '2023-07-30', '2023-08-01', '2023-08-31', frequently_appearing_check=True) NOTE: Note done!!!
simulate(100, 1, stocks, '2023-08-01', '2023-08-31', '2023-09-01', '2023-09-29', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2023-09-01', '2023-09-29', '2023-10-02', '2023-10-31', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2023-10-02', '2023-10-31', '2023-11-01', '2023-11-30', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2023-11-01', '2023-11-30', '2023-12-01', '2023-12-29', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2023-12-01', '2023-12-29', '2024-01-02', '2024-01-31', frequently_appearing_check=True) NOTE: Done


simulate(100, 1, stocks, '2024-01-02', '2024-01-31', '2024-02-01', '2024-02-29', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-02-01', '2024-02-29', '2024-03-01', '2024-03-28', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-03-01', '2024-03-28', '2024-04-01', '2024-04-30', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-04-01', '2024-04-30', '2024-05-01', '2024-05-31', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-05-01', '2024-05-31', '2024-06-03', '2024-06-28', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-06-03', '2024-06-28', '2024-07-01', '2024-07-31', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-07-01', '2024-07-31', '2024-08-01', '2024-08-30', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-08-01', '2024-08-30', '2024-09-03', '2024-09-30', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-09-03', '2024-09-30', '2024-10-01', '2024-10-31', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-10-01', '2024-10-31', '2024-11-01', '2024-11-29', frequently_appearing_check=True) NOTE: Done
simulate(100, 1, stocks, '2024-11-01', '2024-11-29', '2024-12-02', '2024-12-31', frequently_appearing_check=True) NOTE: Done
