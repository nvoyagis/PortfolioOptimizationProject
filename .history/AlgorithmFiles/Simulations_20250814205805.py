...
# simulate(100, 1, stocks, '2023-01-03', '2023-01-31', '2023-02-01', '2023-02-28', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-02-01', '2023-02-28', '2023-03-01', '2023-03-31', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-03-01', '2023-03-31', '2023-04-03', '2023-04-28', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-04-03', '2023-04-28', '2023-05-01', '2023-05-31', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-05-01', '2023-05-31', '2023-06-01', '2023-06-30', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-06-01', '2023-06-30', '2023-07-03', '2023-07-31', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-07-03', '2023-07-31', '2023-08-01', '2023-08-31', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-08-01', '2023-08-31', '2023-09-01', '2023-09-29', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-09-01', '2023-09-29', '2023-10-02', '2023-10-31', frequently_appearing_check=True) Done
# simulate(100, 1, stocks, '2023-10-02', '2023-10-31', '2023-11-01', '2023-11-30', frequently_appearing_check=True) Done
