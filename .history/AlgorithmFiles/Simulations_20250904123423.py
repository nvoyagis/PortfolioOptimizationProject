...
def simulate(sims: int, seed: int, stocks: list[str], begin_data_date: str, buy_date: str, sell1: str, sell2: str, analyze_node_features = False, frequently_appearing_check = False):
    ...
    with open(os.path.join('Simulations', f'[REVERSED] {sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        # nx.draw(g, pos=pos0, node_color='#5192b8', node_size=650)
        # nx.draw(g, pos=pos0, with_labels=True, node_color='#8fd6ff', edge_color='#5192b8', node_size=600, font_size=8)
        nx.draw(g, pos=pos0, with_labels=True, node_color='#a0bec8', edge_color='#a0bec8', node_size=500, font_size=7)
        # Draw edge labels
        edge_labels = nx.get_edge_attributes(g, 'weight')
        for k, v in edge_labels.items():
            edge_labels[k] = round(v, 2)
        ...
        nx.draw(dual, pos, with_labels=True, labels=labels, node_color='#de8585', edge_color='#de8585', node_size=600, font_size=6)
        ...
        highlighted_stocks = ['FDX, EA, DPZ', 'FDX, V, JNPR', 'ADBE, DXCM, HD', 'EA, GOOG, COF', 'KO, JNPR, JPM', 'ADBE, LLY, HD']
        Charts.visualize_multiple_portfolios(allocations, 'Close', begin_data_date, buy_date, sell1, sell2, highlight=highlighted_stocks)
...
simulate(1, 1, stocks4, '2024-01-02', '2024-01-31', '2024-02-01', '2024-02-29', frequently_appearing_check=True) # On poster USE 'stocks4'
...
# simulate(100, 1, stocks, '2024-06-04', '2024-06-28', '2024-07-01', '2024-07-31', frequently_appearing_check=True) 
