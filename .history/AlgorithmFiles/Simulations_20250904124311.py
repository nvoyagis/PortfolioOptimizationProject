...
def simulate(sims: int, seed: int, stocks: list[str], begin_data_date: str, buy_date: str, sell1: str, sell2: str, analyze_node_features = False, frequently_appearing_check = False):
    ...
    with open(os.path.join('Simulations', f'[REVERSED] {sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        Charts.compare_portfolios_to_SPX(allocations, [('FDX', 'EA', 'DPZ'), ('FDX', 'V', 'JNPR'), ('ADBE', 'DXCM', 'HD'), ('EA', 'GOOG', 'COF'), ('KO', 'JNPR', 'JPM'), ('ADBE', 'LLY', 'HD')], begin_data_date, buy_date, sell1, sell2)
