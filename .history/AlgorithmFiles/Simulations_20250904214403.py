...
def simulate(sims: int, seed: int, stocks: list[str], begin_data_date: str, buy_date: str, sell1: str, sell2: str, analyze_node_features = False, frequently_appearing_check = False):
    ...
    with open(os.path.join('Simulations', f'[REVERSED] {sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        highlighted_portfolios = [('KO', 'MAR', 'LLY'), ('DAL', 'JNPR', 'WTW'), ('ALL', 'CPB', 'JNPR'), ('KO', 'NFLX', 'AZO'), ('HAS', 'JNPR', 'T'), ('TGT', 'MA', 'GOOG')]
...
# simulate(100, 1, stocks, '2023-01-03', '2023-01-31', '2023-02-01', '2023-02-28', frequently_appearing_check=True)  
...
# simulate(100, 1, stocks_30, '2024-01-02', '2024-01-31', '2024-02-01', '2024-02-29', frequently_appearing_check=True) # On poster USE 'stocks_30'
...
# simulate(1, 1, stocks, '2024-06-04', '2024-06-28', '2024-07-01', '2024-07-31', frequently_appearing_check=True) 
...
# simulate(100, 1, stocks_30, '2024-09-03', '2024-09-30', '2024-10-01', '2024-10-31', frequently_appearing_check=True) # stocks_30 on poster?
# simulate(100, 1, stocks, '2024-10-01', '2024-10-31', '2024-11-01', '2024-11-29', frequently_appearing_check=True)
simulate(100, 1, stocks_30, '2024-11-01', '2024-11-29', '2024-12-02', '2024-12-31', frequently_appearing_check=True)
