...
def make_TMFG(stocks: list[str], begin_data_date: str, buy_date: str):
    ...
    # pos1 = {node: (x * 0.3, y * 0.3) for node, (x, y) in pos0.items()}  # scale by 3
    ...
    nx.draw(g, pos=pos0, with_labels=True, node_color=node_colors, edge_color='#5192b8', node_size=500, font_size=7, ax=ax)
    # Draw edge labels
...
def simulate(sims: int, seed: int, stocks: list[str], begin_data_date: str, buy_date: str, sell1: str, sell2: str, analyze_node_features = False, frequently_appearing_check = False):
    ...
    with open(os.path.join('Simulations', f'[REVERSED] {sims}_Sims2_{begin_data_date}_to_{buy_date}_and_{sell1}_to_{sell2}.txt'), 'w', newline='') as f:
        ...
        # nx.draw(g, pos=pos0, node_color='#5192b8', node_size=650)
        # nx.draw(g, pos=pos0, with_labels=True, node_color='#8fd6ff', edge_color='#5192b8', node_size=600, font_size=8)
        nx.draw(g, pos=pos0, with_labels=True, node_color='#a0bec8', edge_color='#a0bec8', node_size=500, font_size=12, font_family='STIXGeneral')
        # Draw edge labels
        edge_labels = nx.get_edge_attributes(g, 'weight')
        for k, v in edge_labels.items():
            edge_labels[k] = round(v, 2)
        ...
        plt.tight_layout()
        plt.savefig("tmfg.png", dpi=300, bbox_inches='tight')
        plt.show()
        ...
        plt.axis('off')
        plt.tight_layout()
        plt.savefig("dualtmfg.png", dpi=300, bbox_inches='tight')
        plt.show()
...
stocks_30 = ['DIS', 'KO', 'ADBE', 'AAPL', 'COST', 'CVX', 'EBAY', 'CPB', 'JBHT', 'DLTR', 'WYNN', 'LLY', 'JPM', 'CVS', 'MA', 'BBY', 'MNST', 'KMX', 'EXPE', 'V', 'NKE', 'HSY', 'TGT', 'MRK', 'HD', 'HAS', 'JNJ', 'MCD', 'ALL', 'WTW']




# simulate_all_3combos(10, 1, stocks, '2023-01-31', '2023-02-01', '2023-02-28') 
# simulate_all_3combos(10, 1, stocks, '2023-02-28', '2023-03-01', '2023-03-31')
# simulate_all_3combos(10, 1, stocks, '2023-03-31', '2023-04-03', '2023-04-28') 
# simulate_all_3combos(10, 1, stocks, '2023-04-28', '2023-05-01', '2023-05-31') 
# simulate_all_3combos(10, 1, stocks, '2023-05-31', '2023-06-01', '2023-06-30') 
# simulate_all_3combos(10, 1, stocks, '2023-06-30', '2023-07-03', '2023-07-31')
# simulate_all_3combos(10, 1, stocks, '2023-07-31', '2023-08-01', '2023-08-31') 
# simulate_all_3combos(10, 1, stocks, '2023-08-31', '2023-09-01', '2023-09-29') 
# simulate_all_3combos(10, 1, stocks, '2023-09-29', '2023-10-02', '2023-10-31')
# simulate_all_3combos(10, 1, stocks, '2023-10-31', '2023-11-01', '2023-11-30')
# simulate_all_3combos(10, 1, stocks, '2023-11-30', '2023-12-01', '2023-12-29') 
# simulate_all_3combos(10, 1, stocks, '2023-12-29', '2024-01-02', '2024-01-31')


# simulate_all_3combos(10, 1, stocks, '2024-01-31', '2024-02-01', '2024-02-29')
# simulate_all_3combos(10, 1, stocks, '2024-02-29', '2024-03-01', '2024-03-28')
# simulate_all_3combos(10, 1, stocks, '2024-03-28', '2024-04-01', '2024-04-30')
# simulate_all_3combos(10, 1, stocks, '2024-04-30', '2024-05-01', '2024-05-31') 
# simulate_all_3combos(10, 1, stocks, '2024-05-31', '2024-06-03', '2024-06-28') 
# simulate_all_3combos(10, 1, stocks, '2024-06-28', '2024-07-01', '2024-07-31') 
# simulate_all_3combos(10, 1, stocks, '2024-07-31', '2024-08-01', '2024-08-30') 
# simulate_all_3combos(10, 1, stocks, '2024-08-30', '2024-09-03', '2024-09-30') 
# simulate_all_3combos(10, 1, stocks, '2024-09-30', '2024-10-01', '2024-10-31') 
# simulate_all_3combos(10, 1, stocks, '2024-10-31', '2024-11-01', '2024-11-29') 
# simulate_all_3combos(10, 1, stocks, '2024-11-29', '2024-12-02', '2024-12-31') 
...
# simulate(100, 1, stocks_30, '2023-01-03', '2023-01-31', '2023-02-01', '2023-02-28', frequently_appearing_check=True)  
# simulate(100, 1, stocks_30, '2023-02-01', '2023-02-28', '2023-03-01', '2023-03-31', frequently_appearing_check=True)
# simulate(100, 1, stocks_30, '2023-03-01', '2023-03-31', '2023-04-03', '2023-04-28', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-04-03', '2023-04-28', '2023-05-01', '2023-05-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-05-01', '2023-05-31', '2023-06-01', '2023-06-30', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-06-01', '2023-06-30', '2023-07-03', '2023-07-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-07-03', '2023-07-31', '2023-08-01', '2023-08-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-08-01', '2023-08-31', '2023-09-01', '2023-09-29', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-09-01', '2023-09-29', '2023-10-02', '2023-10-31', frequently_appearing_check=True)
# simulate(100, 1, stocks_30, '2023-10-02', '2023-10-31', '2023-11-01', '2023-11-30', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-11-01', '2023-11-29', '2023-12-01', '2023-12-29', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2023-12-01', '2023-12-29', '2024-01-02', '2024-01-31', frequently_appearing_check=True) 


# simulate(100, 1, stocks_30, '2024-01-02', '2024-01-31', '2024-02-01', '2024-02-29', frequently_appearing_check=True)
# simulate(100, 1, stocks_30, '2024-02-01', '2024-02-29', '2024-03-01', '2024-03-28', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-03-01', '2024-03-28', '2024-04-01', '2024-04-30', frequently_appearing_check=True)
# simulate(100, 1, stocks_30, '2024-04-01', '2024-04-30', '2024-05-01', '2024-05-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-05-01', '2024-05-31', '2024-06-03', '2024-06-28', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-06-04', '2024-06-28', '2024-07-01', '2024-07-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-07-01', '2024-07-31', '2024-08-01', '2024-08-30', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-08-01', '2024-08-30', '2024-09-03', '2024-09-30', frequently_appearing_check=True)
# simulate(100, 1, stocks_30, '2024-09-03', '2024-09-30', '2024-10-01', '2024-10-31', frequently_appearing_check=True) 
# simulate(100, 1, stocks_30, '2024-10-01', '2024-10-31', '2024-11-01', '2024-11-29', frequently_appearing_check=True)
simulate(100, 1, stocks_30, '2024-11-01', '2024-11-29', '2024-12-02', '2024-12-31', frequently_appearing_check=True) # stocks_30 on poster
